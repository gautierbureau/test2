...
from network_factory import (  # noqa: F401 – re-exported for backward compat
...
# ---------------------------------------------------------------------------
#  1.  Build test networks  (implementations live in network_factory.py)
# ---------------------------------------------------------------------------
# build_test_network, build_two_generators_network, build_node_breaker_network,
# and build_node_breaker_network_full are imported from network_factory above.
